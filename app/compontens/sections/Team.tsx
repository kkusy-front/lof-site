                                ...
                                <div className="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-2xl">
                                    <div className="flex flex-col items-center">
                                        <Image width={50} height={50} alt=""
                                            src="/images/microphone.webp" className="bg-white p-2 flex-shrink-0 object-cover object-center flex w-24 h-24 mr-auto ml-auto rounded-full shadow-xl" />
                        ...
                        <div className="items-center w-full mr-auto ml-auto relative max-w-7xl md:px-12 lg:px-24">
                            <div className="grid grid-cols-1">
                                <div className="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-2xl">
                                    <div className="flex flex-col items-center">
                                        <Image width={50} height={50} alt=""
                                            src="/images/bass-guitar.webp" className="bg-white p-2 flex-shrink-0 object-cover object-center flex w-24 h-24 mr-auto ml-auto rounded-full shadow-xl" />
                        ...
                        <div className="items-center w-full mr-auto ml-auto relative max-w-7xl md:px-12 lg:px-24">
                            <div className="grid grid-cols-1">
                                <div className="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-2xl">
                                    <div className="flex flex-col items-center">
                                        <Image width={50} height={50} alt=""
                                            src="/images/melody.webp" className="bg-white p-2 flex-shrink-0 object-contain object-center flex w-24 h-24 mr-auto ml-auto rounded-full shadow-xl" />
                        ...
                        <div className="items-center w-full mr-auto ml-auto relative max-w-7xl md:px-12 lg:px-24">
                            <div className="grid grid-cols-1">
                                <div className="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-2xl">
                                    <div className="flex flex-col items-center">
                                        <Image width={50} height={50} alt=""
                                            src="/images/electric-guitar.webp" className="bg-white p-2 flex-shrink-0 object-cover object-center flex w-24 h-24 mr-auto ml-auto rounded-full shadow-xl" />
                        ...
                        <div className="items-center w-full mr-auto ml-auto relative max-w-7xl md:px-12 lg:px-24">
                            <div className="grid grid-cols-1">
                                <div className="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-2xl">
                                    <div className="flex flex-col items-center">
                                        <Image width={50} height={50} alt=""
                                            src="/images/drum-set.webp" className="bg-white p-2 flex-shrink-0 object-cover object-center flex w-24 h-24 mr-auto ml-auto rounded-full shadow-xl" />
                        ...
                        <div className="items-center w-full mr-auto ml-auto relative max-w-7xl md:px-12 lg:px-24">
                            <div className="grid grid-cols-1">
                                <div className="mt-4 mr-auto mb-4 ml-auto bg-gray-900 max-w-2xl">
                                    <div className="flex flex-col items-center">
                                        <Image width={50} height={50} alt=""
                                            src="/images/saxophone.webp" className="bg-white p-2 flex-shrink-0 object-cover object-center flex w-24 h-24 mr-auto ml-auto rounded-full shadow-xl" />
