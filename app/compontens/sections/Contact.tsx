    ...
    return (
        <section id="kontakt">
            <div className="container mx-auto">
                ...
                <address className="bg-[#191919] rounded-[10px] max-w-4xl mx-2 md:mx-auto p-10 mt-5 flex flex-col justify-center align-middle shadow-2xl gap-20 md:flex-row">
                    <div className="flex flex-col justify-center align-middle">
                        ...
                        <h4 className="font-medium text-base text-center text-white">531 544 665</h4>
                    </div>
                    <div className="flex flex-col justify-center align-middle">
